<?php $__env->startSection('title', 'Dashboard - SEOFAST V3'); ?>
...
<?php $__env->startSection('admin_content'); ?>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e($stats['total_content']); ?></div>
                        <div class="text-xs text-green-600 font-semibold mt-0.5"><?php echo e($stats['published_content']); ?> published</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e($stats['total_users']); ?></div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit">Rp <?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></div>
                        <div class="text-xs text-slate-500 mt-0.5"><?php echo e($stats['total_orders']); ?> total orders</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit">PHP <?php echo e(explode('-', $stats['server']['php_version'])[0]); ?></div>
                        <div class="text-xs mt-0.5">
                            OPCache:
                            <?php if($stats['server']['opcache']): ?>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-slate-200">
            <div class="p-6">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-xl <?php echo e($stats['queue']['status'] === 'stuck' ? 'bg-rose-50 text-rose-600' : ($stats['queue']['status'] === 'running' ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-50 text-slate-400')); ?> flex items-center justify-center">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit">
                            <?php if($stats['queue']['status'] === 'stuck'): ?>
                                <span class="text-rose-600">Stuck</span>
                            <?php elseif($stats['queue']['status'] === 'running'): ?>
                        ...
                        <div class="text-xs mt-0.5 text-slate-500">
                            <?php echo e($stats['queue']['pending']); ?> pending &middot; <?php echo e($stats['queue']['active']); ?> active
                        </div>
                    </div>
                    <form action="<?php echo e(route('admin.dashboard.queue-restart')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            class="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold transition-all
                            <?php if($stats['queue']['status'] === 'stuck' || $stats['queue']['pending'] > 0): ?>
                                bg-rose-500 text-white hover:bg-rose-600 shadow-sm
                            <?php else: ?>
                                bg-slate-100 text-slate-400 cursor-not-allowed
                            <?php endif; ?>"
                            <?php if (! ($stats['queue']['status'] === 'stuck' || $stats['queue']['pending'] > 0)): ?> disabled <?php endif; ?>>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e(number_format($stats['gsc']['clicks'])); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e(number_format($stats['gsc']['impressions'])); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e($stats['gsc']['avg_ctr']); ?>%</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-slate-900 font-outfit"><?php echo e($stats['gsc']['avg_position']); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200">
            <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.gsc.index')); ?>" class="text-xs font-semibold text-brand-indigo hover:text-brand-purple">Details</a>
            </div>
            <div class="px-6 py-5">
                <?php if(count($stats['index_coverage']) > 0): ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $stats['index_coverage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $stateColors = [
                    ...
                    <div class="flex items-center justify-between">
                        <span class="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-semibold <?php echo e($badgeColor); ?>"><?php echo e($shortState); ?></span>
                        <span class="text-sm font-bold text-slate-900"><?php echo e($count); ?></span>
                    </div>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200">
            ...
            <div class="px-6 py-5 space-y-5">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold text-emerald-600"><?php echo e($stats['content_freshness']['last_7']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">Last 30 days</span>
                            <span class="text-sm font-bold text-blue-600"><?php echo e($stats['content_freshness']['last_30']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">Last 90 days</span>
                            <span class="text-sm font-bold text-amber-600"><?php echo e($stats['content_freshness']['last_90']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">90+ days</span>
                            <span class="text-sm font-bold text-red-600"><?php echo e($stats['content_freshness']['older']); ?></span>
                        </div>
                    </div>
                </div>
                <!-- Readability -->
                <div>
                    ...
                    <?php if(array_sum($stats['readability']) > 0): ?>
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">Low (&lt;40)</span>
                            <span class="text-sm font-bold text-red-600"><?php echo e($stats['readability']['low']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">Medium (40-70)</span>
                            <span class="text-sm font-bold text-amber-600"><?php echo e($stats['readability']['medium']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-slate-600">High (&gt;70)</span>
                            <span class="text-sm font-bold text-emerald-600"><?php echo e($stats['readability']['high']); ?></span>
                        </div>
                    </div>
                    <?php else: ?>
                ...
                <div>
                    ...
                    <?php if(count($stats['content_by_status']) > 0): ?>
                    <div class="space-y-2">
                        <?php $__currentLoopData = $stats['content_by_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between">
                            <?php
                                $colors = [
                            ...
                            ?>
                            <span class="text-sm text-slate-600 capitalize"><?php echo e($status); ?></span>
                            <span class="text-sm font-bold <?php echo e($colors[$status] ?? 'text-slate-900'); ?>"><?php echo e($count); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php else: ?>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200">
            <div class="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.redirects.index')); ?>" class="text-xs font-semibold text-brand-indigo hover:text-brand-purple">Manage</a>
            </div>
            <div class="px-6 py-5">
                <?php if($stats['top_redirects']->count() > 0): ?>
                <ul role="list" class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $stats['top_redirects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="py-2.5">
                        <div class="flex items-center justify-between gap-2">
                            <div class="min-w-0 flex-1">
                                <p class="text-sm font-mono text-slate-900 truncate">/<?php echo e($r->old_url); ?> <span class="text-xs text-slate-400">&rarr;</span> <span class="truncate"><?php echo e($r->new_url); ?></span></p>
                            </div>
                            <span class="shrink-0 inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold <?php echo e($r->status_code === 301 ? 'bg-amber-100 text-amber-800' : 'bg-blue-100 text-blue-800'); ?>">
                                <?php echo e($r->status_code); ?>

                            </span>
                            <span class="shrink-0 text-xs font-bold text-slate-500"><?php echo e($r->hits); ?> hits</span>
                        </div>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200">
            ...
            <div class="px-6 py-5">
                <?php if($stats['top_queries']->count() > 0): ?>
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $stats['top_queries']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="py-2 pr-2 font-medium text-slate-900 truncate max-w-[200px]"><?php echo e($q->query); ?></td>
                            <td class="py-2 pr-2 text-right font-bold text-emerald-600"><?php echo e($q->clicks); ?></td>
                            <td class="py-2 pr-2 text-right text-slate-600"><?php echo e($q->impressions); ?></td>
                            <td class="py-2 text-right text-slate-600"><?php echo e($q->avg_pos); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
        ...
        <div class="bg-white shadow-sm rounded-xl border border-slate-200">
            ...
            <div class="px-6 py-5">
                <?php if($stats['top_products']->count() > 0): ?>
                <ul role="list" class="divide-y divide-slate-100">
                    ...
                    <li class="py-3 flex items-center justify-between">
                        <div class="min-w-0 flex-1">
                            <p class="text-sm font-medium text-slate-900 truncate"><?php echo e($product->name); ?></p>
                            <p class="text-xs text-slate-500">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                        </div>
                        <span class="inline-flex items-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-semibold text-indigo-800">
                            <?php echo e($product->invoices_count); ?> orders
                        </span>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
    ...
    <div class="mt-8 bg-white shadow-sm rounded-xl border border-slate-200">
        <div class="px-6 py-4 border-b border-slate-200">
            <h3 class="text-base font-semibold text-slate-900 font-outfit">Konten Baru per Bulan — <?php echo e(now()->year); ?></h3>
        </div>
        <div class="px-6 py-5">
            <?php if(array_sum($stats['monthly_content']) > 0): ?>
            <div class="flex items-end space-x-2 h-40">
                <?php $__currentLoopData = $stats['monthly_content']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="flex-1 flex flex-col items-center">
                    ...
                    <div class="w-full bg-gradient-to-t from-brand-indigo to-brand-purple rounded-t" style="height: <?php echo e($height); ?>%; min-height: <?php echo e($count > 0 ? '4px' : '0'); ?>"></div>
                    <span class="text-xs text-slate-500 mt-1"><?php echo e($monthNames[$month]); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
                ...
                <li class="py-3">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-sm font-semibold text-slate-600">
                            <?php echo e(strtoupper(substr($activity->causer?->name ?? 'S', 0, 1))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Program Marzuki\Projek Framework\SEOFAST\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>