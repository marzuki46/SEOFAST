...
<?php $__env->startSection('meta_description', $homeDesc); ?>
...
<section class="relative pt-32 pb-24 overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="<?php echo e(route('buyer.login')); ?>" class="w-full sm:w-auto text-base font-bold text-white bg-gradient-to-r from-brand-indigo to-brand-purple hover:scale-105 active:scale-95 transition-all px-8 py-4 rounded-2xl shadow-xl shadow-brand-indigo/25">
                Start For Free
            </a>
...
<section class="py-24 border-t border-slate-200 bg-slate-100/30">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <a href="<?php echo e(route('blog.index')); ?>" class="text-sm font-semibold text-brand-indigo hover:text-brand-purple flex items-center gap-2 group transition-colors">
                Visit our Blog 
                ...
                <article class="flex flex-col bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-slate-300 hover:shadow-md transition-all group">
                    <div class="p-6 flex flex-col flex-1">
                        ...
                        <div class="flex items-center gap-3 text-xs text-slate-500 mb-4">
                            ...
                            <span>•</span>
                            <span><?php echo e($post->published_at ? $post->published_at->format('M d, Y') : 'Draft'); ?></span>
                        </div>
                        
                        <h3 class="font-outfit font-bold text-xl text-slate-900 mb-3 line-clamp-2 group-hover:text-brand-indigo transition-colors">
                            <a href="<?php echo e(route('blog.show', $post->slug ?: 'draft')); ?>"><?php echo e($post->title); ?></a>
                        </h3>
                        ...
                        <div class="flex items-center justify-end pt-4 border-t border-slate-100">
                            <a href="<?php echo e(route('blog.show', $post->slug ?: 'draft')); ?>" class="text-xs font-bold text-slate-800 group-hover:text-brand-indigo transition-colors flex items-center gap-1">
                                Read Article 
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div class="p-8 rounded-2xl border border-slate-200 bg-white flex flex-col justify-between hover:border-slate-300 hover:shadow-md transition-all">
                ...
                <a href="<?php echo e(route('buyer.login')); ?>" class="w-full py-3 rounded-xl border border-slate-200 text-center font-bold text-slate-800 hover:bg-slate-50 bg-white transition-all">
                    Get Started
                </a>
            </div>
            ...
            <div class="p-8 rounded-2xl border border-brand-indigo bg-white/80 shadow-lg shadow-brand-indigo/5 flex flex-col justify-between hover:scale-[1.02] transition-all relative">
                ...
                <a href="<?php echo e(route('buyer.login')); ?>" class="w-full py-3 rounded-xl bg-gradient-to-r from-brand-indigo to-brand-purple text-center font-bold text-white hover:opacity-90 transition-all shadow-lg shadow-brand-indigo/15">
                    Start Pro Trial
                </a>
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Program Marzuki\Projek Framework\SEOFAST\resources\views/home.blade.php ENDPATH**/ ?>