...
<body class="h-full font-inter flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        ...
        <div class="bg-white py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-slate-100">
            ...
            <form class="space-y-6" action="{{ route('buyer.login.post') }}" method="POST">
                @csrf
                <div>
        ...
        <p class="text-center text-sm text-slate-600">
            Belum punya akun? <a href="{{ route('buyer.register') }}" class="font-semibold text-brand-indigo hover:text-indigo-600">Daftar sekarang</a>
        </p>
    </div>
</body>
</html>
