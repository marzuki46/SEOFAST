...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div class="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex items-center gap-4">
            ...
            <div>
                <p class="text-xs text-slate-500 font-semibold uppercase tracking-wider mb-0.5">Content Framework</p>
                <p class="text-base font-bold text-slate-900">{{ $silo->framework_label }}</p>
            </div>
        </div>
    </div>
